...
#text area
text_area = tk.Text(root,font="Robote 20", bg ="white",relief="groove",wrap="word")
text_area.place(x=10,y=150,width=500,height=100)

text_area = tk.Text(root,font="Robote 20", bg ="white",relief="groove",wrap="word")
text_area.place(x=10,y=300,width=500,height=100)
...
btn = tk.Button(root,text="Speak",width=10,font="arial 14 bold").place(x=550,y=280)
